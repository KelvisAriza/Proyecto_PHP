...
$eventos = ctrEventos::ctrMostrarEventos();
$roles = ctrRoles::ctrMostrarRoles2();
$participantes = ctrParticipantes::ctrMostrarParticipantes();


if(isset($_SESSION["idBackend"])){

    $admin=ctrUsuarios::ctrMostrarUsuarios1("registroId", $_SESSION["idBackend"]);
}
