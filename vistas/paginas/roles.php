                                        ...
                                        <td>
                                            <div class='btn-group'>
                                                ...
                                                <button class="btn btn-warning btn-sm btnEditarRoles"
                                                    data-toggle="modal" idRol="<?php echo $value["usuarioId"]?>"
                                                    data-target="#modal-editar-rol">
                                                    <i class="fas fa-pencil-alt text-white"></i>
                                                </button>

                                                <button class="btn btn-danger btn-sm eliminarRol"
                                                    idRolesE="<?php echo $value["usuarioId"]  ?>">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group has-feedback" bis_skin_checked="1">
                    ...
                    <input type="text" class="form-control" id="nom_rolE" name="nom_rolE" placeholder="Nombre de Rol">
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                </div>
